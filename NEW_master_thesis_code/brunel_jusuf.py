...
params = {
    ...
    'rounding': {roundit},  # whether to round spike times
...
def build_network():
    ...
    recorder_label = os.path.join(
        params['path_name'],
        'brunel_rounding_' + str(params['rounding']) + '_delay_' + str(params['min_delay']) + '_' +
    ...
    nest.Connect(nodes_ex, nodes_ex + nodes_in, conn_params_ex,
                 syn_spec={'weight': J_ex, 'delay': nest.random.uniform(params['min_delay'],
                                                                        params['max_delay'])})
    ...
    nest.Connect(nodes_in, nodes_ex + nodes_in, conn_params_in,
                 syn_spec={'weight': J_in, 'delay': nest.random.uniform(params['min_delay'],
                                                                        params['max_delay'])})
