...
sim_dict.update({
    ...
    'print_time': False,
    'kwds': {kwds},
    'sim_resolution': {resolution}  # want to be able to change the resolution of the simulations.
})
...
net_dict.update({
    ...
    'network_type': {NETWORK_TYPE} # added parameter to change, network type either droop or equal
})
