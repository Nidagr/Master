...
class Network:
    ...
    def __create_poisson_bg_input(self):
        ...
        self.poisson_bg_input = nest.Create('poisson_generator_ps',  # continuous version
                                            n=self.num_pops)
        if self.nest_version == '3':
    ...
    def __create_thalamic_stim_input(self):
        ...
        self.thalamic_population = nest.Create(
            'parrot_neuron_ps', n=self.stim_dict['num_th_neurons'])  # continuous version

        self.poisson_th = nest.Create('poisson_generator_ps')  # continuous version
        if self.nest_version == '3':
            self.poisson_th.set(
